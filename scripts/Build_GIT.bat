...
:: Build
"%WINDIR%\Microsoft.NET\Framework\v4.0.30319\MSBUILD.exe" /target:Rebuild /property:Configuration=RELEASE /fl /flp:logfile=SpectrumAnalyzer.log;verbosity=diagnostic SpectrumAnalyzer.sln
